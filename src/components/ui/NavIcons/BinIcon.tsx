...
export default function BinIcon({maxReached}: IconProps){
   return( <svg filter="drop-shadow(2px 2px 2px rgba(0,0,0,0.5))" className="w-4.75 h-4.75 sm:w-7 sm:h-7" viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg"> <g stroke={`${maxReached ? 'white' : 'gray'}`}  strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none">
